  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Seus dados no VIVA" },
      {
        ...
        content: "Transparência sobre armazenamento local, uso das informações e como apagar tudo.",
      },
      ...
      <Screen>
        ...
        <SectionCard title="Onde essas informações ficam">
          <p className="text-text-primary">
            Tudo fica no armazenamento local deste dispositivo, no seu navegador. Nesta versão não
            existe conta, servidor, envio de dados nem compartilhamento com terceiros.
          </p>
        </SectionCard>

        <SectionCard title="Para que são usadas">
          <p className="text-text-primary">
            Apenas para mostrar de novo o que você já escolheu e manter a interface do jeito que
            você prefere. Nada é usado para medir desempenho, comparar pessoas ou estimular tempo de
            uso.
          </p>
        </SectionCard>
        ...
        <SectionCard title="Apagar tudo">
          <p className="text-text-primary">
            Você pode apagar suas escolhas e preferências deste dispositivo. Essa ação não pode ser
            desfeita.
          </p>
          ...
          {!confirmando ? (
            ...
            <div className="mt-4 rounded-2xl border border-border-default p-4">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3">
                ...
                <TextAction onClick={() => setConfirmando(false)}>Manter meus dados</TextAction>
              </div>
            </div>
          )}
          ...
          {apagado ? (
            <div className="mt-4">
              <Confirmacao>
                Dados apagados deste dispositivo. Você pode começar de novo quando quiser.
              </Confirmacao>
            </div>
          ) : null}
        </SectionCard>
        ...
        <Note>
          Se algum dia o VIVA passar a guardar informações fora do seu dispositivo, isso será
          explicado antes, em linguagem simples, e dependerá da sua escolha.
        </Note>
      </Screen>
    </>
  );
