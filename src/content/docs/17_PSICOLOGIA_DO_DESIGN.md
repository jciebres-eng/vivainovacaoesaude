**17_PSICOLOGIA_DO_DESIGN.md**

**VIVA**

**Psicologia do Design**

**Framework para Desenvolvimento de Tecnologias Humanizadas**
...
explicar claramente o que acontece;
...
permitir desfazer ações quando possível;

comunicar limitações do sistema.
...
Cada tela deverá responder uma única pergunta principal.
...
A previsibilidade aumenta confiança.

O usuário deve conseguir antecipar:
...
Toda interação deve produzir sensação de orientação.
...
A confiança é construída pela coerência.

O sistema deverá:

cumprir aquilo que comunica;

explicar suas limitações;

assumir incertezas;

informar claramente quando utilizar processamento automatizado.

A confiança não depende apenas da segurança técnica.
...
informar possíveis soluções;

permitir nova tentativa;

preservar a autoestima do usuário.
...
pressão temporal injustificada;

contadores destinados apenas a aumentar permanência.

O retorno do usuário deve ocorrer porque percebe valor na experiência.
...
Quem poderá encontrar dificuldades?

Existe alternativa mais simples?

A interface respeita diferentes capacidades funcionais?
...
Ela não mede seu sucesso pela quantidade de cliques.
...
Neste projeto, Psicologia e Engenharia não ocupam posições opostas.
...
A Ciência avalia seus resultados.

A Ética estabelece seus limites.
...
A interface comunica clareza?

Reduz carga cognitiva?

Respeita diferentes formas de funcionamento?
