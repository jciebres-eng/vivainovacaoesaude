...
A plataforma existe para apoiar decisões, nunca para substituí-las.

O sistema organiza possibilidades.

A decisão permanece com a pessoa.
...
Entretanto, a experiência do usuário será organizada em torno:
...
• compreender características do público;

• orientar acessibilidade;

• apoiar requisitos funcionais;

• permitir interoperabilidade futura.

Não serão utilizados para:

• classificar automaticamente usuários;

• definir percursos obrigatórios;
...
Pode apresentar conteúdos educativos.

Pode apoiar planejamento.

Pode registrar experiências.

Não indica tratamentos específicos.

Não define condutas clínicas.
...
Toda sugestão deverá ser transparente, explicável e opcional.
...
O usuário nunca será obrigado a seguir percursos previamente definidos.
...
Os determinantes sociais da saúde fazem parte da construção do cuidado.
...
Recursos imersivos constituem módulos complementares.

Jamais serão obrigatórios.
...
Jamais serão iniciados automaticamente.

Todo estímulo dependerá da escolha do usuário.
...
• múltiplas decisões simultâneas;
...
Cada tela deverá possuir um objetivo principal claramente identificado.
...
Foi criado para aumentar experiências reais.

A plataforma deverá incentivar continuamente:
...
• descanso da tecnologia.

O melhor uso do sistema é aquele que permite viver melhor fora dele.
...
O usuário controla o compartilhamento.
...
Cada profissional visualizará apenas os dados autorizados.
...
Serão identificados separadamente.

A plataforma não mistura interpretações.

Cada perspectiva permanece preservada.
...
Pretende ampliar possibilidades.

Não pretende substituir relações humanas.

Pretende fortalecê-las.

Não pretende normalizar diferenças.

Pretende respeitar singularidades.

Não pretende transformar o usuário em paciente permanente.

Pretende apoiar sua autonomia.

Não pretende manter pessoas conectadas à tecnologia.

Pretende ajudá-las a viver melhor fora dela.
